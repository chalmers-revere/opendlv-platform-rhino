...
sed_arg="s/hostname=.*/hostname=revere-rhino-x86_64-1/; \
  ...
  s/eth_dhcp_client_dev=.*/eth_dhcp_client_dev=( enp2s0 )/; \
  s%hdd=.*%hdd=${hdd}%; \
...
sed_arg="s/subnet=.*/subnet=10.40.40.0/; \
	s/dhcp_clients=.*/dhcp_clients=( \
	  ...
	  'axis-m1124-fl-0,ac:cc:8e:23:6e:8d,50', \
	  'dalsa-c2450-fl-0,00:01:0d:c3:84:f8,60', \
	  'dalsa-c2450-fr-1,00:01:0d:c3:84:f7,61', \
